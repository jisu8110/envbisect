...
3. 설계·연구 근거: [Handoff Condensed](EnvBisect_Handoff_Condensed.md)
4. 화면 의도: [UI 기획안](기획안.md)

`sources/`는 문서가 인용하는 초기 Handoff와 사전 snapshot 측정 자료입니다. 이 자료의 수치를 현재 앱 실행 결과와 합산하지 마세요. 최신 앱의 원시 로그, API 키와 개인 설정은 공개 저장소에 포함하지 않습니다.
